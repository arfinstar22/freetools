...
export const ValueProps: React.FC = () => {
  return (
    <section className="w-full max-w-6xl mx-auto px-4 py-12 sm:py-16 border-t border-slate-200 dark:border-slate-900 transition-colors">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="p-5 sm:p-6 rounded-2xl bg-white/70 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800/80 space-y-2.5 sm:space-y-3 shadow-sm dark:shadow-none backdrop-blur-sm">
      ...
      <div className="mt-12 sm:mt-16 p-6 sm:p-8 rounded-3xl bg-white/80 dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-none backdrop-blur-sm">
